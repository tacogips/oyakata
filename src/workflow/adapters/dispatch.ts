import { AdapterExecutionError, type AdapterExecutionContext, type AdapterExecutionInput, type AdapterExecutionOutput, type NodeAdapter } from "../adapter";
import type { CliAgentBackend, NodeExecutionBackend, NodePayload } from "../types";
import { AnthropicSdkAdapter, type AnthropicSdkAdapterConfig } from "./anthropic-sdk";
...
export function resolveNodeExecutionBackend(node: NodePayload): NodeExecutionBackend {
